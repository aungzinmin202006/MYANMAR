...
os.system('xdg-open https://www.facebook.com/groups/483783567010955')
...
def main():
    ...
    print(' [2] Start Uid Cloning')
    print(' [3] Start Number Cloning')
    print(' [4] Start Gmail Cloning')
    print(' [5] Start username Cloning')
    print(' [6] Contact me Fb')
