...
for nt in range(10000):
	...
	xx=f"Mozilla/5.0 (Windows NT 10.1; {str(rr(9,12))}; Win64; x64){str(aZ)}{str(rx)}{str(aZ)}) AppleWebKit/605.1.15 (KHTML, like Gecko){str(rr(99,151))}.0.{str(rr(4600,4999))}.{str(rr(35,99))} Chrome/{str(rr(99,175))}.0.{str(rr(0,5))}.{str(rr(0,5))} Safari/604.1"
	rug.append(xx)
ruz=[]
